...
// Function to hide the share buttons
function hideShareButtons() {
  const shareButtons = document.querySelector(".custom-share-buttons");
  if (shareButtons) {
...
window.addEventListener("scroll", hideShareButtons);

// Add an event listener to run the code once the DOM is fully loaded
document.addEventListener("DOMContentLoaded", () => {
  // Initialize the state of share buttons
  hideShareButtons();
});
...
document.addEventListener(&quot;DOMContentLoaded&quot;, function() {
    ...
    shareButtons.forEach(function(button) {
        button.addEventListener(&quot;click&quot;, function(e) {
            ...
            // Get the social media platform from the class name
            const platform = this.classList.contains(&quot;facebook&quot;)
                ...
                : this.classList.contains(&quot;pinterest&quot;)
                ? &quot;https://pinterest.com/pin/create/button/?url=&quot; + encodeURIComponent(currentURL)
                : &quot;&quot;;

            // Open a new window or tab with the sharing link
            if (platform) {
  ...
  document.addEventListener(&quot;DOMContentLoaded&quot;, function() {
    ...
    var parentElement = document.querySelector(&#39;.navbar-nav&#39;);

    // Create a new unordered list element
    var newList = document.createElement(&#39;ul&#39;);
    newList.setAttribute(&#39;class&#39;, &#39;navbar-nav px-4 p-lg-0 container&#39;);

    // Iterate through each list item and move it to the new list
    var listItems = document.querySelectorAll(&#39;.navbar-nav &gt; li&#39;);
    listItems.forEach(function(item) {
      newList.appendChild(item);
    });

    // Append the new list to the parent element
